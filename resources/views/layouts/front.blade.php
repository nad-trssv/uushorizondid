                    ...
                    <div class="col-12 col-md-4 text-center text-md-end">
                      ...
                      <div class="uh-iban mt-2">
                        ...
                        <div class="uh-iban-box d-inline-flex align-items-center gap-2 mt-1">
                            <span class="uh-copy-msg" aria-live="polite">Скопировано</span><button type="button" class="uh-copy" data-copy="#ibanText" aria-label="Скопировать IBAN" title="Скопировать IBAN">
                                <i class="fa-regular fa-copy"></i>
                            </button>
                          <span class="uh-iban-code" id="ibanText">EE087700771011884557</span>
                        </div>
                      </div>
