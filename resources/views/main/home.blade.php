		...
		<section class="content-inner overflow-hidden">
			<div class="container">
				...
				<div class="row justify-content-center">
					<div class="col-lg-3 col-md-6 col-sm-6 m-b30 text-center">
						<a href="https://www.instagram.com/" target="_blank" class="social-link" style="color: #E4405F;">
							<i class="fab fa-instagram fa-3x"></i>
							<p class="m-t10">Instagram</p>
						</a>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-6 m-b30 text-center">
						<a href="https://www.facebook.com/" target="_blank" class="social-link" style="color: #1877F2;">
							<i class="fab fa-facebook-f fa-3x"></i>
							<p class="m-t10">Facebook</p>
						</a>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-6 m-b30 text-center">
						<a href="https://www.youtube.com/" target="_blank" class="social-link" style="color: #FF0000;">
							<i class="fab fa-youtube fa-3x"></i>
							<p class="m-t10">YouTube</p>
						</a>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-6 m-b30 text-center">
						<a href="https://www.tiktok.com/" target="_blank" class="social-link" style="color: #000000;">
							<i class="fab fa-tiktok fa-3x"></i>
							<p class="m-t10">TikTok</p>
						</a>
					</div>
				</div>
			</div>
